...
const Footer = () => {
    ...
    const linkSections = [
        { title: 'PRODUCTS', links: [{ text: 'Earphones', path: '/' }, { text: 'Headphones', path: '/' }, { text: 'Smartphones', path: '/' }, { text: 'Laptops', path: '/' }] },
        { title: 'WEBSITE?', links: [{ text: 'Home', path: '/' }, { text: 'Privacy Policy', path: '/' }, { text: 'Become Plus Member', path: '/pricing' }, { text: 'Create Your Store', path: '/create-store' }] },
        { title: 'CONTACT', links: [{ text: '+1-212-456-7890', path: '/', icon: MailIcon }, { text: 'contact@example.com', path: '/', icon: PhoneIcon }, { text: '794 Francisco, 94102', path: '/', icon: MapPinIcon }] }
    ]
    ...
    return (
        <footer className="mx-6 bg-white">
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
                    <div>
                        <Link to="/" className="inline-block">
                            <img src={assets.yourcart_logo} alt="YourCart Logo" className="w-32 h-auto" />
                        </Link>
                        <p className="max-w-[410px] mt-6 text-sm">Welcome to YourCart, your ultimate destination for the latest and smartest gadgets. From smartphones and smartwatches to essential accessories, we bring you the best in innovation — all in one place.</p>
                ...
                <p className="py-4 text-sm text-slate-500">Copyright 2025 © YourCart All Right Reserved.</p>
            </div>
        </footer>
    )
}
